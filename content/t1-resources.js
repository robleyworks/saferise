...
var T1_PROTOCOL_KEYS = {
  "t1-01": { reader: "t1p1", keys: ["t1p1-meditation", "t1p1-crisiscard", "t1p1-guide", "t1p1-companion", "t1p1-practice", "t1p1-advisory", "t1p1-disclosure", "t1p1-record", "t1p1-accountability", "t1p1-decision"] },
  "t1-02": { reader: "t1p2", keys: ["t1p2-meditation", "t1p2-crisiscard", "t1p2-guide", "t1p2-companion", "t1p2-practice", "t1p2-advisory", "t1p2-disclosure", "t1p2-repair", "t1p2-record", "t1p2-accountability", "t1p2-decision"] },
  "t1-03": { reader: "t1p3", keys: ["t1p3-meditation", "t1p3-crisiscard", "t1p3-guide", "t1p3-companion", "t1p3-practice", "t1p3-advisory", "t1p3-disclosure", "t1p3-record", "t1p3-accountability", "t1p3-decision"] },
  "t1-04": { reader: "t1p4", keys: ["t1p4-meditation", "t1p4-crisiscard", "t1p4-guide", "t1p4-companion", "t1p4-practice", "t1p4-advisory", "t1p4-disclosure", "t1p4-repair", "t1p4-record", "t1p4-accountability", "t1p4-decision"] },
  "t1-05": { reader: "t1p5", keys: ["t1p5-meditation", "t1p5-crisiscard", "t1p5-guide", "t1p5-companion", "t1p5-practice", "t1p5-disclosure", "t1p5-record", "t1p5-accountability", "t1p5-decision"] },
  "t1-06": { reader: "t1p6", keys: ["t1p6-meditation", "t1p6-crisiscard", "t1p6-guide", "t1p6-companion", "t1p6-practice", "t1p6-disclosure", "t1p6-record", "t1p6-accountability", "t1p6-decision"] },
  "t1-07": { reader: "t1p7", keys: ["t1p7-meditation", "t1p7-crisiscard", "t1p7-guide", "t1p7-companion", "t1p7-practice", "t1p7-disclosure", "t1p7-record", "t1p7-accountability", "t1p7-decision"] },
  "t1-08": { reader: "t1p8", keys: ["t1p8-meditation", "t1p8-crisiscard", "t1p8-guide", "t1p8-companion", "t1p8-practice", "t1p8-advisory", "t1p8-disclosure", "t1p8-repair", "t1p8-record", "t1p8-accountability", "t1p8-decision"] },
  "t1-09": { reader: "t1p9", keys: ["t1p9-meditation", "t1p9-crisiscard", "t1p9-guide", "t1p9-companion", "t1p9-practice", "t1p9-advisory", "t1p9-disclosure", "t1p9-repair", "t1p9-record", "t1p9-accountability", "t1p9-decision"] },
  "t1-10": { reader: "t1p10", keys: ["t1p10-meditation", "t1p10-crisiscard", "t1p10-guide", "t1p10-companion", "t1p10-practice", "t1p10-advisory", "t1p10-disclosure", "t1p10-record", "t1p10-accountability", "t1p10-crisis", "t1p10-decision"] }
};
...
*/
  {
    ...
    body:[
      ...
      "<div class='sr-script-card'><span class='sr-section-kicker'>SHORTER VERSION — SAY IT OR SEND IT</span><blockquote>“I’m working on how I handle anger. If I ask for a little space, I’m not shutting you out — I’m trying to come back to the conversation with the part of me that can actually think and speak clearly.”</blockquote></div>",
